...
public class Second2 implements SecondInt {
	...
	public Second2(JPanel argP,JPanel argP1, JPanel argP2, CardLayout argL,JFrame argF) {
		this.MainPanel = argP;
	...
	public void Create(){
		...
		Qna.setFont(new Font("배달의민족 한나는 열한살", 0, 150));
	...
	public void PrintBtn(){
		...
		else if(qna.equals("4 X 8 = ?")){
			btn1.setIcon(new ImageIcon("img/"+(btnqna+1)+".png"));
			btn2.setIcon(new ImageIcon("img/"+(btnqna+2)+".png"));
			btn3.setIcon(new ImageIcon("img/"+(btnqna)+".png"));
			btn4.setIcon(new ImageIcon("img/"+(btnqna-1)+".png"));
	}
		else if(qna.equals("6 X 5 = ?")){
			btn1.setIcon(new ImageIcon("img/"+(btnqna)+".png"));
